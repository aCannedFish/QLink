...
template <> constexpr inline auto SimpleTest::qt_create_metaobjectdata<qt_meta_tag_ZN10SimpleTestE_t>()
{
    ...
    QtMocHelpers::StringRefStorage qt_stringData {
        "SimpleTest",
        "testSimpleModeCanLinkInLine",
        "",
        "testSimpleModeCanLinkWithOneCorner",
        "testSimpleModeCanLinkWithTwoCorners",
        "testSimpleModeCanLink",
        "testDuoModeCanLinkInLine",
        "testDuoModeCanLinkWithOneCorner",
        "testDuoModeCanLinkWithTwoCorners",
        "testDuoModeCanLink"
    };

    QtMocHelpers::UintData qt_methods {
        // Slot 'testSimpleModeCanLinkInLine'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'testSimpleModeCanLinkWithOneCorner'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'testSimpleModeCanLinkWithTwoCorners'
        QtMocHelpers::SlotData<void()>(4, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'testSimpleModeCanLink'
        QtMocHelpers::SlotData<void()>(5, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'testDuoModeCanLinkInLine'
        QtMocHelpers::SlotData<void()>(6, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'testDuoModeCanLinkWithOneCorner'
        QtMocHelpers::SlotData<void()>(7, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'testDuoModeCanLinkWithTwoCorners'
        QtMocHelpers::SlotData<void()>(8, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'testDuoModeCanLink'
...
void SimpleTest::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->testSimpleModeCanLinkInLine(); break;
        case 1: _t->testSimpleModeCanLinkWithOneCorner(); break;
        case 2: _t->testSimpleModeCanLinkWithTwoCorners(); break;
        case 3: _t->testSimpleModeCanLink(); break;
        case 4: _t->testDuoModeCanLinkInLine(); break;
        case 5: _t->testDuoModeCanLinkWithOneCorner(); break;
        case 6: _t->testDuoModeCanLinkWithTwoCorners(); break;
        case 7: _t->testDuoModeCanLink(); break;
        default: ;
        }
    }
    (void)_a;
